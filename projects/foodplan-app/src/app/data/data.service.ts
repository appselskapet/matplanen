...
import * as collection from "projects/foodplan-app/src/assets/data/data.json";
...
export class DataService {
  ...
  dishes: any = (collection as any).default;
...
//    console.log(this.dishes);
  ...
  getRandomDish(category?:string) {
    let array = [];
    if (category) {
      array = this.dishes.collection.filter((x: Dish) => x.category === category);
    } else {
      array = this.dishes.collection;
    }
